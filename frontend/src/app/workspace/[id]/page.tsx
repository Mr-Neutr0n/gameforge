...
function GamePreviewArea() {
  return (
    <div className="flex h-full flex-col">
      {/* Preview toolbar */}
      <div className="flex h-12 shrink-0 items-center justify-between border-b border-card-border px-4">
        <div className="flex items-center gap-3">
          <h3 className="text-sm font-medium text-foreground">Preview</h3>
          <span className="rounded-md bg-card px-2 py-0.5 text-xs text-muted border border-card-border">
            Game
          </span>
        </div>
      ...
      <div className="flex flex-1 items-center justify-center bg-[#0a0a0a] p-4">
